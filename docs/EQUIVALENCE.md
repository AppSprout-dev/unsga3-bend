...
This is **not** a NuGet package. PackageId `Unsga3` stays the C# / NuGet / GitHub Packages stack. Planned first Bend hub version is **0.1.0** (content-hash; hash filled at publish).
