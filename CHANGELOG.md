...
The format follows [Keep a Changelog](https://keepachangelog.com/en/1.1.0/). The first planned hub version is **0.1.0**. That version is **not published yet**: no `v0.1.0` tag, and `bend … --publish` waits until after the public-docs review merges.
...
- ZDT2 **quality** A/B: gens=**250**, `PymooCompatible`, p=12, pop=52 ([`ab/protocol.py`](ab/protocol.py))
